...
{
    /// <summary>
    /// Esta clase representa un DTO (Data Transfer Object) para la entidad Rent.
    /// </summary>
    public class RentDto
    {
        ...
        /// </summary>
        public VehicleDto Vehicle { get; set; } // Navigation property to Vehicle entity

        /// <summary>
        /// Gets or sets el cliente que alquila el vehículo.
        /// </summary>
        public ClientDto Client { get; set; } // Navigation property to User entity
